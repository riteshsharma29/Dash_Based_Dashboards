...
4. Physics_Latex_Lexcture_Dashboard.py : Is dashboard application developed to share LaTeX files in HTML. All html files (in Latex folder) are served through xampp localhost server. 
